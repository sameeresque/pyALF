# pyALF
An Absorption Line Finding Tool. pyALF looks for weak HI absorption lines in the spectra of quasars, and returns a list of absorption line systems. This is done in two steps:
